...
<body>
    <div class="thankyou-content text-center">
        <h3 style="line-height: 1.5">Email Sent Successfully.We have sent a verification link to your provided email address. Please check your email...<br> If not there please check spam folder</h3>
